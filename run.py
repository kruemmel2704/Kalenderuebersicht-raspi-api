...
from PyQt5.QtWidgets import (
    ...
    QLabel, QFrame, QScrollArea, QSlider, QPushButton, QDialog,
    QLineEdit, QListWidget, QListWidgetItem, QGridLayout, QSizePolicy
)
from PyQt5.QtGui import QFont, QPixmap, QIcon

# 1. Safe helper to parse .env file
...
class CalendarWidget(QWidget):
    ...
    def init_ui(self):
        ...
        if os.path.exists(logo_path):
            ...
            self.logo_label.setPixmap(pix.scaled(140, 50, Qt.KeepAspectRatio, Qt.SmoothTransformation))
        ...
        self.title_lbl.setStyleSheet("color: #ffffff; font-size: 26px; font-weight: bold;")
        title_col.addWidget(self.title_lbl)

        self.date_lbl = QLabel("Heute ist ...")
        self.date_lbl.setObjectName("SubTitle")
        self.date_lbl.setStyleSheet("color: #94a3b8; font-size: 13px;")
        ...
        self.spotify_layout.setContentsMargins(10, 8, 10, 8)
        self.spotify_layout.setSpacing(12)

        # Spotify logo / Icon
        self.sp_logo = QLabel("Spotify")
        self.sp_logo.setStyleSheet("color: #1DB954; font-weight: bold; font-size: 13px;")
        self.spotify_layout.addWidget(self.sp_logo)

        # Track details text
        self.track_info = QLabel("Keine Wiedergabe aktiv")
        self.track_info.setStyleSheet("color: #e2e8f0; font-size: 12px;")
    ...
    def update_events_ui(self, data):
        ...
        self.status_lbl.setStyleSheet("color: #10b981; font-size: 11px; background-color: rgba(30, 41, 59, 0.5); border: 1px solid #2a4365; border-radius: 10px; padding: 3px 8px;")
        ...
        for i in range(5):
            ...
            if not events:
                ...
                no_ev.setStyleSheet("border: 1px dashed #2a4365; border-radius: 8px; padding: 15px;")
                ...
                for ev in events:
                    ...
                    time_lbl.setStyleSheet("color: #60a5fa; font-weight: bold; font-size: 11px;")
                    ...
                    if travel:
                        if travel.get("driving"):
                            ...
                            t_badge.setStyleSheet("color: #10b981; font-weight: bold; font-size: 10px;")
                            time_row.addWidget(t_badge)
                        if travel.get("walking"):
                            w_badge = QLabel(f"🚶 {travel['walking']}")
                            w_badge.setStyleSheet("color: #3b82f6; font-weight: bold; font-size: 10px;")
                    ...
                    title.setStyleSheet("color: #e2e8f0; font-weight: 500; font-size: 12px;")
                    ...
                    if loc:
                        ...
                        loc_lbl.setStyleSheet("color: #94a3b8; font-size: 10px;")
                    ...
                    if assign:
                        ...
                        ass_lbl.setStyleSheet("color: #94a3b8; font-size: 10px; font-style: italic;")
    ...
    def show_connection_error(self, err_msg):
        ...
        self.status_lbl.setStyleSheet("color: #ef4444; font-size: 11px; background-color: rgba(30, 41, 59, 0.5); border: 1px solid #2a4365; border-radius: 10px; padding: 3px 8px;")
